...
func (p *ProductService) UpdateAllProduct(id int, product domain.Product) (productUpdated domain.Product, err error) {
	productUpdated, err = p.productRepository.UpdateAllProduct(id, product)

	return
}
func (p *ProductService) UpdateProductPartial(id int, product domain.Product) (productUpdated domain.Product, err error) {
	productUpdated, err = p.productRepository.UpdateProductPartial(id, product)
